...
<>
{
  feedback.length > 0 ?        <section className='w-full bg-gradient-to-r from-blue-500 to-purple-500 h-auto px-[20px] md:px-[30px] lg:px-[50px] xl:px-[100px] py-[40px] lg:py-[70px]'>
      ...
      {feedback?.slice(0, 9).map((data, index) => (
        <div key={index} className="p-[18px] rounded-[10px] shadow-md bg-white">
          {/* Header Section */}
          ...
          >
            ...
            <div className="flex items-center justify-between mb-[10px] p-[15px] space-x-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-[3px]">
                  {Array.from({ length: Math.round(selectedData.rating) }, (_, i) => (
                    <FaStar key={i} className="text-orange-500" />
                  ))}
                  {Array.from({ length: 5 - Math.round(selectedData.rating) }, (_, i) => (
                    <FaRegStar key={i} className="text-gray-400" />
                  ))}
                  <span className="ml-2 text-sm font-semibold text-gray-600">
            ...
            >
              ...
              {/* -------------box----------------- */}
{
  feedback?.length > 9 ?    <div className="flex w-full items-center justify-center mt-[50px] z-[100]">
     <NavLink to="/feedback">
