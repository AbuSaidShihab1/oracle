...
const [payment,set_payment]=useState([]);
  ...
  return (
    <>
    {
      payment.length > 0 ?       <section className='w-full bg-gradient-to-r from-blue-500 to-purple-500 h-auto px-[20px] md:px-[30px] lg:px-[50px] xl:px-[100px] py-[70px] '>
...
{
  payment?.length > 8 ?    <div className="flex w-full items-center justify-center mt-[50px] z-[100]">
