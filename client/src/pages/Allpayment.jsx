...
const [payment,set_payment]=useState([]);
  ...
  <div class="absolute w-5 h-5 bg-white rounded-full animate-bubble left-40 bottom-15 delay-1000"></div>
     {/* -------------hero section------------ */}
       ...
       <div className='text-center w-[90%] lg:w-[90%]  font-noto-sans'>
            <h1 className='text-[20px] lg:text-[40px] font-bold mb-[10px] text-white'>আমাদের গ্রাহক ওরাকল টেকনোলজি বিশ্বাস করে যেভাবে পেমেন্ট করেন তাদরে কিছূ পেমেন্ট প্রুভ দেখুন ।</h1>
            <p className='text-[16px]  lg:text-[18px] text-neutral-200'>অনলাইনে এতো এতো প্রতারনা চলছে যা বলার বাহিরে এই প্রতারনার যুগে আমারা শতভাগ সচ্ছতার সাথে কাজ করে যাচ্ছি তারপর হাজার সচ্ছতার মাঝে কিছু এন্টি পার্টি আছে যারা প্রতারনা করে তারা আমাদের নামে নেগেটিভ তথ্য ছড়ায় যার জন্য আমরা আপনাদের দেখাচ্ছি কত শত মানুষ এর আস্তা ওরাকল টেনোলজীর উপর তা আপনি নিজেই দেখে নিন ।</p>
        </div>
      </div>
    {/* ------------hero section------------ */}
  </div>
 ...
 {/* --------------------------section--------------- */}
        ...
        <h1 className='px-[25px] rounded-full font-bangla_font text-center w-auto text-[22px] lg:text-[30px] py-[10px] bg-green-700 border-[3px] border-white text-white'>
    ...
    <section className='pt-[50px] grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-[20px]'>
          {
            payment.map((data)=>{
              ...
              <div className='w-full h-auto p-[3px] lg:p-[5px] bg-white rounded-[10px]'>
                 <img className='w-full rounded-[10px]'  src={`${base_url}/images/${data.image}`} alt="" />
              </div>
              )
            })
          }
