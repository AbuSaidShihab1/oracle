...
const Apiprovider = () => {
  ...
  <div class="absolute w-5 h-5 bg-white rounded-full animate-bubble left-40 bottom-15 delay-1000"></div>
     {/* -------------hero section------------ */}
        <div className="hero w-full flex justify-center  items-center z-[1]">
            ...
            <h1 className='text-[20px] lg:text-[40px] font-bold mb-[10px] text-white'>আমরা যাদের গেমিং এ পি আই ব্যাবহার করি আপনাদের সাইট এর জন্য ।</h1>
            <p className='text-[16px]  lg:text-[18px] text-neutral-200'>আমরা নিচের দেওয়া প্রভাইডারদের এ পি আই ব্যাবহার করে থাকি আপনাদের বেটিং সাইট গুলো ডেভেলপমেন্ট করার জন্য তাদের সাথে আমরা পার্টনার হিসাবে যুক্ত আছি এবং অনুমেদিত লাইসেন্স প্রদানকারী হিসাবে আমরা কাজ করছি ।</p>
        </div>
      </div>
    {/* ------------hero section------------ */}
  </div>
 ...
 {/* --------------------------section--------------- */}
        ...
        <h1 className='px-[25px] font-bangla_font rounded-full text-center w-auto text-[22px] lg:text-[30px] py-[10px] bg-green-700 border-[3px] border-white text-white'>
