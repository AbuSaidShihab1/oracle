  ...
  <div class="absolute w-5 h-5 bg-white rounded-full animate-bubble left-40 bottom-15 delay-1000"></div>
     {/* -------------hero section------------ */}
        ...
        <div className='text-center w-[90%] lg:w-[90%]  font-noto-sans'>
            <h1 className='text-[20px] lg:text-[40px] font-bold mb-[10px] text-white'>আমাদের গ্রাহক ওরাকল টেকনোলজি সম্পর্কে কি বলেন রিভিউ গুলো দেখুন</h1>
            <p className='text-[16px]  lg:text-[18px] text-neutral-200'>যেহেতু আমাদের টিম টোটাল রিমোটলি কাজ করে তাই আমরা চেষ্টা করি শতভাগ কাজের নিশ্চয়তা আপনাদের সকল এর আস্তা এবং ভালোবাসায় বিগত ৬ বছর ধরে ওরাকল টিম বেটিং সাইট ডেভেলপমেন্ট প্রজেক্ট নিয়ে কাজ করছেন আমরা প্রায় ৪০০+ সাইট ডেভেলপমেন্ট করেছি ।</p>
        </div>
      </div>
    {/* ------------hero section------------ */}
  </div>
        ...
        <section className='pt-[50px] grid lg:grid-cols-2 xl:grid-cols-3  gap-[20px]'>
            {
             ...
             {/* Content Section */}
             {
               data.message.length > 150 ?       <p className="mt-3 text-[16px] font-[600] font-bangla_font text-neutral-600 leading-relaxed">
