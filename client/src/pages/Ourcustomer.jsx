     ...
     {/* -------------hero section------------ */}
        <div className="hero w-full flex justify-center items-center z-[1]">
         <div className='text-center w-[90%] lg:w-[90%]  font-noto-sans'>
            <h1 className='text-[20px] lg:text-[40px]  font-bold mb-[10px] text-white'>যারা আমাদের মাধ্যমে বিভিন্ন কাজ করে নিয়েছেন তাদরে কিছূ তথ্য আমাদের গ্রাহক যারা</h1>
            <p className='text-[16px]  lg:text-[18px] text-neutral-200'>নিচের দেওয়া সাইট গুলো আমদের সেবা গ্রহন করেছেন এবং আমরা নিচের দেওয়া সাইট গুলো ডেভেলপমেন্ট করেছি আপনি চাই  যে কোন ডিজাইন বেটিং সাইট , ই-কমার্স সাইট, ইনভেস্টমেন্ট সাইট , পি টি সি সাইট, ট্রেডিং সাইট সহ যে কোন ধরনের ওয়েব সাইট এপস আমাদের মাধ্যমে ডেভেলপমেন্ট করে নিতে পারেন ।</p>
        </div>
      </div>
    {/* ------------hero section------------ */}
  </div>
