...
const handleSubmit = async (e) => {
  ...
  if (!member_name || !designation || !facebook_link || !twitter_link) {
  ...
  Swal.fire({
    title: "Submitting...",
    html: "Please wait while your member is being added.",
  ...
  try {
    ...
    const response = await axios.post(`${base_url}/admin/add-member`, formData, {
      headers: {
  ...
  return (
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <div className='w-full flex justify-between items-center'>
        <div>
              <h1 className='text-[20px] lg:text-[20px] font-[600] mb-[8px]'>Add Member</h1>
    ...
    <div className="relative w-[60%] lg:w-[50%] xl:w-[30%] h-[200px] mb-[30px]">
      ...
      <div className="w-[100%] mt-[15px]">
        <label htmlFor="students" className="text-[15px] font-[500] text-gray-600">
         Memeber Facebook Link <span className="text-red-500">*</span>
        </label>
        <input
          type="text"
          name="students"
      ...
      <div className="w-[100%] mt-[15px]">
        <label htmlFor="price" className="text-[15px] font-[500] text-gray-600">
          Memeber Twitter Link <span className="text-red-500">*</span>
        </label>
        <input
          type="text"
          name="price"
