...
const handleSubmit = async (e) => {
  ...
  formdata.append("tutorial_banner",tutorial_banner)
  ...
  try {
    Swal.fire({
      title: "Uploading...",
      html: "Please wait while we upload your data.",
    ...
    const response = await axios.post(`${base_url}/admin/add-website`, formdata, {
      headers: {
    ...
    Swal.close(); // Close the progress bar popup
...
const formats = [
              ...
              <div className="w-full h-full rounded-[10px] overflow-hidden border-2 border-gray-300">
                {profileImage ? (
                  ...
                  <div className="flex items-center justify-center w-full h-full bg-gray-200 text-gray-500">
                    <span className="text-sm">Upload Main Design</span>
                  </div>
                )}
              </div>
              <label
  ...
  <div className="w-[100%] lg:w-[50%]">
        ...
        <div className="w-[100%]">
          ...
          />
            ...
            <div className="w-full flex gap-[10px] lg:gap-[30px] mb-[10px]">
              ...
              <div className="w-[100%]">
                <label className="text-[15px] font-[500] text-gray-600">
                 Tutorial Banner<span className="text-red-500">*</span>
                </label>
                <input
                  type="file"
                  name="tutorial_banner"
                  placeholder="Tutorial Banner"
                  onChange={(e)=>{set_tutorialbanenr(e.target.files[0])}}
              ...
              <div className="w-[100%]">
                <label className="text-[15px] font-[500] text-gray-600">
                 Top Title BG Banner<span className="text-red-500">*</span>
                </label>
                <input
                  type="file"
                  name="tutorialLink"
              ...
              <div className="w-[100%]">
                <label className="text-[15px] font-[500] text-gray-600">
                  Middle  BG Banner<span className="text-red-500">*</span>
                </label>
                <input
                  type="file"
                  name="tutorialLink"
              ...
              <div className="w-[100%]">
                <label className="text-[15px] font-[500] text-gray-600">
                  First Side Banner<span className="text-red-500">*</span>
                </label>
                <input
                  type="file"
                  name="tutorialLink"
              ...
              <div className="w-[100%]">
                <label className="text-[15px] font-[500] text-gray-600">
                  Second Side Banner<span className="text-red-500">*</span>
                </label>
                <input
                  type="file"
              ...
              <div className="w-[100%]">
                <label className="text-[15px] font-[500] text-gray-600">
                  Third Side Banner<span className="text-red-500">*</span>
                </label>
                <input
                  type="file"
                  name="tutorialLink"
   ...
   <div className="w-full flex gap-[10px] lg:gap-[30px] mb-[10px]">
              <div className="w-[100%]">
                <label className="text-[15px] font-[500] text-gray-600">
                  Second Video Link <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  name="tutorialLink3"
