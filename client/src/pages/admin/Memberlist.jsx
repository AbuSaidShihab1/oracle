...
const [members,set_member]=useState([]);
    ...
    // ----------course searching system
     const [searchQuery, setSearchQuery] = useState("");
      const filteredCourses = members.filter(member =>
    ...
    member.designation.toString().includes(searchQuery)
      ...
      const confirm_box=confirm("Are you sure?");
       if(confirm_box){
       axios.delete(`${base_url}/admin/delete-member/${id}`, {
                headers: {
  ...
  return (
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <div className='w-full flex justify-between items-center'>
        <div>
              <h1 className='text-[20px] lg:text-[20px] font-[600] mb-[8px]'>Members List</h1>
        ...
        {/* -------------search-box------------------ */}
   {
    members.length > 0 ?       <div className="w-[30%]">
...
:""
   ...
   <section className="pt-[40px] pb-[30px]">
       {
        members.length > 0 ?     <div className="relative overflow-x-auto border-[1px] border-[#eee] rounded-[5px]">
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border-l border-r border-b border-gray-200 dark:border-gray-700">
            <thead className="text-xs text-white uppercase bg-indigo-500 dark:bg-gray-700 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 border-r border-gray-200 dark:border-gray-700 text-[15px] font-[500] text-nowrap">Designation</th>
              ...
              {filteredCourses.map((data, index) => (
                <tr key={index} className="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <td className="w-32 p-4 border-r border-gray-200 dark:border-gray-700">
                    <img src={`${base_url}/images/${data.image}`} alt="member" className="w-32 h-[80px] rounded-md" />
                  </td>
                  ...
                  <td className="px-6 py-2 flex justify-center items-center gap-[8px]">
                    ...
                    <div onClick={()=>{delete_member(data._id)}} className="font-medium text-white dark:text-red-500 hover:underline p-[10px] text-[22px] cursor-pointer bg-red-500 rounded-[5px]">
                      <MdDeleteOutline />
                    </div>
                  </td>
                </tr>
